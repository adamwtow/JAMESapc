...
//#include "visp_hand2eye_calibration/start.h" 
#include <vector>
...
namespace visp_hand2eye_calibration{ 
	class Client
	{
		...
		//visp_hand2eye_calibration::start start_comm;
		...
		typedef boost::function<void (const geometry_msgs::Transform::ConstPtr& trans)> world_effector_subscriber_callback_t;

		//! subscriber type declaration for world->effector topic subscriber
		//typedef boost::function<void (const std_msgs::Empty &msg)> start_subscriber_callback_t;
		typedef boost::function<void (const std_msgs::Empty::ConstPtr& msg)> start_subscriber_callback_t;

		void cameraObjectCallback_(const geometry_msgs::Transform::ConstPtr& trans);
		void worldEffectorCallback_(const geometry_msgs::Transform::ConstPtr& trans);
		void testCallback(const geometry_msgs::Transform::ConstPtr& trans);
		//void startCallback_(const std_msgs::Empty &msg);
		void startCallback_(const std_msgs::Empty::ConstPtr& msg);
