#ifndef ROS_KINFU_LS_PUBLISHER_H
#define ROS_KINFU_LS_PUBLISHER_H
...
class ros_kinfu_ls_publisher
{
public:
    ros_kinfu_ls_publisher(ros::NodeHandle nh_);
...
#endif // ros_kinfu_ls_publisher_H
