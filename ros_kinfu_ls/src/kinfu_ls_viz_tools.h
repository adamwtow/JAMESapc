#ifndef KINFU_LS_VIZ_TOOLS_H
#define KINFU_LS_VIZ_TOOLS_H
...
#include <pcl/gpu/kinfu_large_scale/color_handler.h>
...
public:
  ImageView();
  void  showScene (KinfuTracker& kinfu, const PtrStepSz<const pcl::gpu::kinfuLS::PixelRGB>& rgb24, bool registration, Eigen::Affine3f* pose_ptr = 0);
...
public:
  ...
  inline void  drawCamera (Eigen::Affine3f& pose, const string& name, double r, double g, double b);
