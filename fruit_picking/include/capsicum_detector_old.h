#ifndef CAPSICUM_DETECTOR
#define CAPSICUM_DETECTOR
...
class capsicum_detector{
    ...
    void filter_image(cv::Mat &Image, cv::Mat &filtered_Image);

    void segmentImage(cv::Mat &inputImage, cv::Mat &outputImage, double threshold);

    void segmentImage(HSV_model A, cv::Mat &inputImage, cv::Mat &outputImage);

    void segmentImage(BGR_model A, cv::Mat &inputImage, cv::Mat &outputImage);
    private:
